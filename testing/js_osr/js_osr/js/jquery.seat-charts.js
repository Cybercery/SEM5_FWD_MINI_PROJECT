...
(function ($) {
  ...
  $.fn.seatCharts = function (setup) {
            ...
            .addClass(
              ["seatCharts-seat", "seatCharts-cell", "available"]
                .concat(
                  ...
                  fn.settings.classes,
                  typeof seatChartsSettings.seats[fn.settings.character] ==
                    "undefined"
                    ? []
          ...
          (function (seatSettings, character, seat) {
            ...
            $.each(["click", "focus", "blur"], function (index, callback) {
              ...
              fn[callback] = function () {
                 ...
                 */
                return fn.style(
                  typeof seatSettings[character][callback] === "function"
                    ...
                    case 39:
                      ...
                      $newSeat = (function ($seats) {
                        if (!$seats.index($seat) && e.which == 37) {
                          ...
                          return $seats.eq(
                            $seats.index($seat) + (e.which == 37 ? -1 : +1)
                          );
                        }
                      })(
                        $seat
    ...
    $.each(settings.map, function (row, characters) {
      ...
      $.each(
        characters.match(/[a-z_]{1}(\[[0-9a-z_]{0,}(,[0-9a-z_ ]+)?\])?/gi),
